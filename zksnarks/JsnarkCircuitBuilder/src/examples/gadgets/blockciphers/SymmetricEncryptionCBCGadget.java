...
/**
 * Performs symmetric encryption in the CBC mode. Only supports one cipher
 * (speck128) as an example at the moment. Other ciphers will be integrated
 * soon.
 *
 */
public class SymmetricEncryptionCBCGadget extends Gadget {
	...
	public SymmetricEncryptionCBCGadget(Wire[] plaintextBits, Wire[] keyBits, Wire[] ivBits, String cipherName, String... desc) 
	{
		super(desc);
