	...
	public void testCase1() {
		...
		CircuitGenerator generator = new CircuitGenerator("Speck128_Test") {
			...
			public void generateSampleInput(CircuitEvaluator evaluator) 
			{
				...
				evaluator.setWireValue(key[0], new BigInteger("1011121314151617", 16));
				evaluator.setWireValue(key[1], new BigInteger("18191a1b1c1d1e1f", 16));

				evaluator.setWireValue(plaintext[0], new BigInteger("6867666564636261", 16));
				evaluator.setWireValue(plaintext[1], new BigInteger("3837363534333231", 16));
			}	
		};
		...
		// My test                                                              
		assertEquals(evaluator.getWireValue(cipherText.get(0)), new BigInteger("eb43938a5b6059e0", 16));
		assertEquals(evaluator.getWireValue(cipherText.get(1)), new BigInteger("f166e1fd253b004c", 16));
	}
}
